...
namespace ESHOPMAT.Models
{
    ...
    public class PageContent
    {
        ...
        public Dictionary<string, string> Data
        {
            get
            {
                var x = PageContentDictionaryCache.GetAll();
                var y = PageContentDictionaryCache.Get(SharedId)?.Data;
                if (y == null)
                {
    ...
    public class PageDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new PageImageConfiguration()); // Apply configuration for PageImage
        }
    }
